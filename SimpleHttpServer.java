...
public class SimpleHttpServer {
    ...
    public static void main(String[] args) throws Exception {
        // Change the port number to something else if 4001 is in use
        ...
        server.createContext("/static", new StaticFileHandler("static")); // Serve static files from "static" directory
...
class MyHttpHandler implements HttpHandler {
    ...
    private void handlePostRequest(HttpExchange httpExchange) throws IOException {
        ...
        if (contentType != null && contentType.startsWith("multipart/form-data")) {
            ...
            System.out.println(fileSavedAs);
            List<String> generatedFiles = CertificateGen.Generate("certificate_template3.svg", fileSavedAs);
